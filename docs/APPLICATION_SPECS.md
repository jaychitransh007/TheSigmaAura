...
- 3-column PDP outfit cards in chat UI: thumbnail rail, hero image viewer, info panel with style archetype radar chart and feedback CTAs
...
Each `_pct` field is an integer percentage (0–100) scoring how strongly the outfit expresses that style archetype's aesthetic. These scores are displayed as a radar chart in the UI card. The 8 archetypes match the system's style archetype vocabulary: classic, dramatic, romantic, natural, minimalist, creative, sporty, edgy.
