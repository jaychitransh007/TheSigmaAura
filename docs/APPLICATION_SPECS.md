...
- **8 evaluation criteria scores** — how well the outfit fits this specific user (body harmony, color suitability, style fit, risk tolerance, occasion, comfort boundary, specific needs, pairing coherence). Displayed as color-coded progress bars in the UI card. Fallback path derives these from `assembly_score * 100`.
- **8 style archetype scores** — how strongly the outfit expresses each archetype's aesthetic, based on garment characteristics not user preference (classic, dramatic, romantic, natural, minimalist, creative, sporty, edgy). Displayed as a radar chart in the UI card.
...
- 8 evaluation criteria progress bars (color-coded: green ≥80%, yellow ≥60%, red <60%)
...
- Style archetype radar chart (Canvas-rendered, 8 axes: Classic, Dramatic, Romantic, Natural, Minimalist, Creative, Sporty, Edgy)
  - Grid rings at 25%, 50%, 75%, 100%
  - Purple fill polygon with data points
- 8 evaluation criteria progress bars (body harmony, color suitability, style fit, risk tolerance, occasion, comfort, specific needs, pairing)
