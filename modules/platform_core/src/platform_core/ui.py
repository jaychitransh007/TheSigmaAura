...
(function() {{
  ...
  // All three ``one_piece`` shapes (underscore / space / hyphen) —
  // wardrobe rows surface in any of them depending on how they were
  // enriched. Mirrors the backend ``_CANONICAL_NON_SHOE_CATEGORIES``.
  var CANONICAL_NON_SHOE_CATEGORIES = ["top", "bottom", "outerwear", "one_piece", "one piece", "one-piece", "set"];
