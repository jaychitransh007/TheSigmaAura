...
class AgenticOrchestrator:
    ...
    def _handle_planner_pipeline(
        ...
        *,
        ...
        # Episodic memory for the architect (PR #90, May 5 2026): raw
        ...
        # context-dependent patterns and bias retrieval queries.
        # Tolerate exceptions AND non-list returns (test mocks default
        # to Mock objects, not lists) so the pipeline still ships on
        # cold paths and during legacy test wiring.
        #
        # archetypal_preferences (the aggregate like/dislike axes) was
        # dropped May 8 2026: the rater (PR #89) and composer (May 8)
        # both moved off it; recent_user_actions is the richer signal.
        try:
